...
from ShuKurenaiXRoBot import DEV_USERS, LOGGER, OWNER_ID, dispatcher
from ShuKurenaiXRoBot.modules.helper_funcs.chat_status import dev_plus, sudo_plus
from ShuKurenaiXRoBot.modules.sql.users_sql import get_all_users
...
def chat_checker(update: Update, context: CallbackContext):
    bot = context.bot
    try:
        if update.effective_message.chat.get_chat_member(bot.id).can_send_messages is False:
